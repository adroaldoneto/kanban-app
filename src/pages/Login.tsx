...
import { Kanban, Mail, Lock, Eye, EyeOff, AlertCircle } from 'lucide-react'
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-600 via-purple-600 to-indigo-800 items-center justify-center p-12">
        <div className="text-white max-w-md">
          ...
          <p className="text-xl text-indigo-100 mb-6">
            Sistema completo de gestão com Kanban, escalas, relatórios Gantt e muito mais.
          </p>
          <div className="space-y-4 text-indigo-200">
            <div className="flex items-center gap-3">
              <div className="w-2 h-2 bg-indigo-300 rounded-full" />
              <span>Quadro Kanban com drag & drop</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-2 h-2 bg-indigo-300 rounded-full" />
              <span>Gestão de escalas integrada</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-2 h-2 bg-indigo-300 rounded-full" />
              <span>Relatórios com gráfico Gantt</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-2 h-2 bg-indigo-300 rounded-full" />
              <span>Exportação em PDF e envio por email</span>
            </div>
          </div>
        </div>
      </div>
