...
export default function LoginPage() {
  const { login, loginWithGoogle, resetPassword, loading, error, clearError } = useAuthStore();
    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-500 mt-1 text-sm">Sistema integrado de Kanban & Escalas</p>
        </div>
        ...
        <div className="card p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" disabled={loading} className="btn-primary w-full mt-2">
              {loading ? 'Aguarde...' : resetMode ? 'Enviar e-mail' : 'Entrar'}
            </button>
          </form>
            ...
            <>
              <div className="relative my-5">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="bg-gray-900 px-3 text-gray-500">ou continue com</span>
                </div>
              </div>
